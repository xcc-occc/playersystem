            ...
            <div class="col-md-10">
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">球员管理</div>
                            </div>
                            <div class="bootstrap-admin-panel-content">
                                <ul>
                                    <li>根据球员编号、球员名称查询球员基本信息</li>
                                    <li>添加、修改、删除球员</li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">球员信息</div>
                            </div>
                            <div class="bootstrap-admin-panel-content">
                                <ul>
                                    <li>展示所有球员的信息</li>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">话题</div>
                            </div>
                            <div class="bootstrap-admin-panel-content">
                                <ul>
                                    <li>展示所有话题信息，并可置顶一条话题</li>
                                </ul>
                            </div>
                        </div>
                    </div>
