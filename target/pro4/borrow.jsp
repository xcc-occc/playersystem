...
<%@ page import = "com.rain.bean.AdminBean,com.rain.bean.HistoryBean,com.rain.dao.PlayerDao,com.rain.dao.AdminDao" %>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">当前收藏信息</div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <%
                             ArrayList<HistoryBean> playerdata = new ArrayList<HistoryBean>();
                             playerdata = (ArrayList<HistoryBean>)request.getAttribute("data");
                           if(playerdata==null){
                        	   PlayerDao playerdao = new PlayerDao();
                        	   playerdata = (ArrayList<HistoryBean>)playerdao.get_HistoryListInfo(aid);
                           }
  for (HistoryBean bean : playerdata){
  %>                 
                            	<tbody>
	                         	   	<td><%= bean.getHid() %></td>
	                         	   	<td><%= bean.getBid() %></td>
