...
<button type="button" class="btn btn-danger btn-xs" onclick="deleteplayer(<%= bean.getAid() %>)">删除</button>
	</td>
                          	  </tbody>
                       <%} %>
                        </table>
										...
										<div class="form-group">
										 ...
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">姓名</label>
												<div class="col-sm-7">
													<%--@declare id="updateplayername"--%><input type="text" class="form-control" id="updatename" name="name"  placeholder="">
										...
										<div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">密码</label>
												<div class="col-sm-7">
                                                    ...
                                                    <input type="hidden" id="updatelend_num1" name="lend_num">
                                                    <input type="hidden" id="updatemax_num2" name="max_num">
												<label class="control-label" for="updatePress" style="display: none;"></label>
												</div>
										</div>
									...
									<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										...
										<div class="form-group">
										 ...
										 <div class="form-group">
											<label for="firstname" class="col-sm-3 control-label">姓名</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" name="name" id="addplayerName" required="required"  placeholder="请输入姓名">
