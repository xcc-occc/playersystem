...
<%@ page import = "com.rain.bean.AdminBean,com.rain.bean.TopicBean,com.rain.dao.TopicDao,com.rain.dao.AdminDao" %>
<%@ page import="com.rain.bean.jbBean" %>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">举报记录</div>
                            </div>
                        ...
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <tr>
	                            ...
	                            <th>举报日期</th>
                            	 ...
                            	 <%
                             ArrayList<jbBean> jbdata = new ArrayList<jbBean>();
                             jbdata = (ArrayList<jbBean>)request.getAttribute("data");
                           if(jbdata==null){
                        	   TopicDao topicdao = new TopicDao();
                        	   jbdata = (ArrayList<jbBean>)topicdao.get_jbListInfo();
                           }
  for (jbBean bean : jbdata){
  %>                 
                            	<tbody>
	                         	   	<td><%= bean.getTid() %></td>
	                                <td><%= bean.getName() %></td>
	                                <td><%= bean.getContent() %></td>
	                                <td><%= bean.getFbtime() %></td>
	                                <td><%= bean.getJbtime() %></td>
