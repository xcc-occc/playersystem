...
<%@ page import = "com.rain.bean.AdminBean,com.rain.dao.AdminDao,com.rain.bean.TopicBean,com.rain.dao.TopicDao" %>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default bootstrap-admin-no-table-panel">
                        <div class="panel-heading">
                            <div class="text-muted bootstrap-admin-box-title">发表话题</div>
                        </div>
                        <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                            <form class="form-horizontal" action="/pro4/PuttopicServlet" method="post">
                                <input type="hidden" name="tip" value="2">
                                <div class="col-lg-8 form-group">
                                    <%--@declare id="query_bname"--%><label class="col-lg-4 control-label" for="query_bname">话题</label>

                                    <div class="col-lg-8">
                                        <input class="form-control" id="TopicContent" name="content" type="text" value="">
                                ...
                                <div class="col-lg-4 form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary" id="btn_query" >发表</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <td><button type="button" class="btn btn-info btn-xs" data-toggle="modal" onclick="borrowbook(<%= bean.getTid() %>)" >举报</button>   	</td>
            ...
            <script type="text/javascript">
                function borrowbook(tid) {

                    con=confirm("是否举报?");
                    if(con==true){
                        location.href = "/pro4/jubaServlet?tid="+tid;
                    }
                }
            </script>
        </div>
